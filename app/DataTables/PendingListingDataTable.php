...
class PendingListingDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            <button type="button" class="btn btn-dark dropdown-toggle ml-2 btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            ->addColumn('status', function ($query) {
                $html = '<select name="" class="form-control approve">
