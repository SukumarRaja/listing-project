...
@section('contents')
    ...
    <div id="breadcrumb_part"
        style="background: url({{ $listing->thumbnail_image }}); background-size: cover; background-repeat: no-repeat; background-position:center;">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="listing_details_text">
                        ...
                        @if ($listing->goolge_map_embed_code)
                            <div class="listing_det_location">
                                {!! $listing->goolge_map_embed_code !!}
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="listing_det_side_address">
                                    ...
                                    @if ($listing->website)
                                        <p><i class="fal fa-globe"></i><a
                                                href="{{ $listing->website }}">{{ $listing->website }}</a></p>
                                    @endif
                                ...
                                <div class="col-12">
                                    <div class="listing_det_side_list">
                                        ...
                                        @foreach ($similarListings as $similar)
                                            <a href="{{ route('listing.show', $similar->slug) }}"
                                                ...
                                                <div class="sidebar_blog_text">
                                                    <h5>{{ truncate($similar->title) }}</h5>
                                                    <p> <span>{{ date('M d Y', strtotime($similar->created_at)) }}
                                                        </span> 2 Comment </p>
                                                </div>
                                            </a>
                                        @endforeach
