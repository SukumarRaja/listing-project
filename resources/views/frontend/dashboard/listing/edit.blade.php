                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="image-preview" class="image-preview image">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="image-preview-2" class="image-preview thumbnail">
                                                <label for="image-upload-2" id="image-label-2">Choose File</label>
                                                <input type="file" name="thumbnail_image" id="image-upload-2" />
                                                <input type="hidden" name="old_thumbnail_image" id="image-upload-2"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category" id="" class="form-control" required>
                                                ...
                                                @foreach ($categories as $category)
                                                    <option @selected($listing->category_id === $category->id) value="{{ $category->id }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="location" id="" class="form-control" required>
                                                ...
                                                @foreach ($locations as $location)
                                                    <option @selected($listing->location_id === $location->id) value="{{ $location->id }}">
